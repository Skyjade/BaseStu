...
flowableModeler
  ...
  .config(['$provide', '$routeProvider', '$selectProvider', '$translateProvider', function ($provide, $routeProvider, $selectProvider, $translateProvider) {
    ...
    $routeProvider
        .when('/processes', {
            templateUrl: appResourceRoot + 'design/views/processes.html',
            controller: 'ProcessesCtrl'
        })
        .when('/processes/:modelId', {
            templateUrl: appResourceRoot + 'design/views/process.html',
        ...
        .when('/casemodels', {
            templateUrl: appResourceRoot + 'design/views/casemodels.html',
            controller: 'CaseModelsCtrl'
        })
        .when('/casemodels/:modelId', {
            templateUrl: appResourceRoot + 'design/views/casemodel.html',
            controller: 'CaseModelCtrl'
        })
        .when('/forms', {
            templateUrl: appResourceRoot + 'design/views/forms.html',
            controller: 'FormsCtrl'
        })
        .when('/forms/:modelId', {
            templateUrl: appResourceRoot + 'design/views/form.html',
            controller: 'FormCtrl'
        })
        ...
        .when('/decision-tables', {
            templateUrl: appResourceRoot + 'design/views/decision-tables.html',
            controller: 'DecisionTablesController'
        })
        .when('/decision-tables/:modelId', {
            templateUrl: appResourceRoot + 'design/views/decision-table.html',
        ...
        .when('/apps', {
            templateUrl: appResourceRoot + 'design/views/app-definitions.html',
            controller: 'AppDefinitionsCtrl'
        })
        .when('/apps/:modelId', {
            templateUrl: appResourceRoot + 'design/views/app-definition.html',
        ...
        .when('/editor/:modelId/', {
            templateUrl: appResourceRoot + 'design/editor-app/editor.html',
            controller: 'EditorController'
        })
        .when('/form-editor/:modelId', {
            templateUrl: appResourceRoot + 'design/views/form-builder.html',
        ...
        .when('/decision-table-editor/:modelId', {
            templateUrl: appResourceRoot + 'design/views/decision-table-editor.html',
            controller: 'DecisionTableEditorController'
        })
        .when('/app-editor/:modelId', {
            templateUrl: appResourceRoot + 'design/views/app-definition-builder.html',
