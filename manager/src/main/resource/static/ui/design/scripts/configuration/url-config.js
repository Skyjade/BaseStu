...
FLOWABLE.APP_URL = {
    ...
    getCmmnModelDownloadUrl: function (modelId, modelHistoryId) {
    	if(modelHistoryId == null || modelHistoryId == undefined){
    		return FLOWABLE.CONFIG.contextRoot + '/app/rest/models/' + modelId + '/history/'+'/cmmn?version=' + Date.now();
    	}
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/models/' + modelId + '/history/' + modelHistoryId + '/cmmn?version=' + Date.now();
    },
    ...
    getCaseModelsUrl: function (query) {
    	if(query == null || query == undefined){
    		 return FLOWABLE.CONFIG.contextRoot + '/app/rest/case-models';
    	}
    ...
    getModelThumbnailUrl: function (modelId, version) {
    	if(version == null || version == undefined){
    		return FLOWABLE.CONFIG.contextRoot + '/app/rest/models/' + modelId + '/thumbnail' + "?version=" + "";
    	}
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/models/' + modelId + '/thumbnail' + "?version=" + version;
    },
